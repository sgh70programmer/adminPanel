        ...
        <section id="sidebar_section">
            <div className={`mini_sidebar collapsedd bg-dark h-100 ${showSidebar ? "expanded" : null}`}>
                <ul className="p-0 m-0">
                    ...
                    <SidebarItem targetPath="/" icon="fas fa-tachometer-alt" title="داشبورد" pTitle="read" />
                    {/* <!-- =================================== --> */}
                    ...
                    <SidebarItem targetPath="/guaranties" icon="fab fa-pagelines" title="مدیریت گارانتی ها" pTitle="read_guaranties" />
